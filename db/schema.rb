...
ActiveRecord::Schema.define(version: 20190502131604) do
  ...
  create_table "microposts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["tasks_id"], name: "index_microposts_on_tasks_id", using: :btree
  end
  ...
  add_foreign_key "microposts", "tasks", column: "tasks_id"
